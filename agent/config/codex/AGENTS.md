...
### xcode (MCP)
- Apple プラットフォーム向けアプリの build、run、test、debug は Xcode 標準 MCP を優先して使用する
- 操作前に Xcode で開いている project / workspace、scheme、destination を確認し、対象を取り違えないようにする
- build / test の結果は diagnostics や build log まで確認し、エラー内容と未検証範囲を明示する
